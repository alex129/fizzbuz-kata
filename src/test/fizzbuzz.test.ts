...
describe('Fizz buzz', () => {
  ...
  test('When I fizzbuzz number 15, I get back "FizzBuzz"', async () => {
    const result = fizzbuzz(15);
    expect(result).toBe('FizzBuzz');
  });

  test('When I fizzbuzz number 30, I get back "FizzBuzz"', async () => {
    const result = fizzbuzz(30);
    expect(result).toBe('FizzBuzz');
  });

  test('When I fizzbuzz number 45, I get back "FizzBuzz"', async () => {
    const result = fizzbuzz(45);
    expect(result).toBe('FizzBuzz');
  });

  test('When I fizzbuzz number 0, I get back "FizzBuzz"', async () => {
